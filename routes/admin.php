...
use App\Http\Controllers\Payment\PiprapayAdminController;
...
Route::get('/mypanel', [AdminController::class, 'admin_dashboard'])->name('admin.dashboard')->middleware(['auth', 'admin', 'prevent-back-history']);
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin', 'prevent-back-history']], function () {
    ...
    // PipraPay Admin Refund
    Route::post('/piprapay/refund', [PiprapayAdminController::class, 'refund'])->name('admin.piprapay.refund');
