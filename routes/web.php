...
Route::controller(CartController::class)->group(function () {
    ...
    Route::post('/cart/addtocart_temp', 'addtocart_temp')->name('cart.addToCartTemp');
...
Route::controller(PiprapayController::class)->group(function () {
    Route::get('/payment/piprapay/pay', 'pay')->name('piprapay.pay');
    Route::match(['get', 'post'], '/payment/piprapay/return', 'return')->name('piprapay.return');
    Route::post('/payment/piprapay/webhook', 'webhook')->name('piprapay.webhook');
    Route::get('/payment/piprapay/cancel', 'cancel')->name('piprapay.cancel');
});
...
// courier
Route::post('/courier/order', [CourierOrderController::class, 'createOrder']);
Route::post('/courier/order/bulk', [CourierOrderController::class, 'bulkCreateOrders'])->name('bulkCreateOrders');
Route::get('/courier/order/status/consignment/{id}', [CourierOrderController::class, 'checkStatusByConsignmentId']);
Route::get('/courier/order/status/invoice/{invoice}', [CourierOrderController::class, 'checkStatusByInvoice']);
Route::get('/courier/order/status/tracking/{trackingCode}', [CourierOrderController::class, 'checkStatusByTrackingCode']);
Route::get('/courier/balance', [CourierOrderController::class, 'getBalance']);
