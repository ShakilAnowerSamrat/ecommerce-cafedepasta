    ...
    public function getList(Request $request)
    {
        ...
        if ($list == "online" || $list == "both") {
            ...
            if (get_setting('instamojo_payment') == 1) {
                ...
                $payment_type['details'] = "";
                if ($mode == 'wallet') {
                    $payment_type['title'] = "Recharge with Instamojo";
                }
            ...
            if (get_setting('piprapay') == 1 || get_setting('piprapay_payment') == 1) {
                $payment_type = array();
                $payment_type['payment_type'] = 'piprapay';
                $payment_type['payment_type_key'] = 'piprapay';
                $payment_type['image'] = static_asset('assets/img/cards/piprapay.png');
                $payment_type['name'] = "PipraPay";
                $payment_type['title'] = "Checkout with PipraPay";
                $payment_type['offline_payment_id'] = 0;
                $payment_type['details'] = "";
                if ($mode == 'wallet') {
                    $payment_type['title'] = "Recharge with PipraPay";
                }
