...
class OrderController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $delivery_boys=[];
        if(@$order_shipping_address->city){
    ...
    public function store(Request $request)
    {
        ...
        $shippingAddress['name']        = $request->name ?? null;
        $shippingAddress['phone']       = $request->phone ?? null;
        $shippingAddress['address']     = $request->address ?? null;
