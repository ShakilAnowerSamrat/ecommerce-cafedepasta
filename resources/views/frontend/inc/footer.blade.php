...
<section class="py-3 text-light footer-widget border-bottom" style="border-color: #333232 !important; background-color: #212121 !important;">
    <div class="container">
        <!-- footer logo -->
        <div class="mt-3 mb-4">
...
@endphp
<section class="py-lg-3 text-light footer-widget" style="background-color: #212121 !important;">
    ...
    <div class="d-lg-none bg-transparent">
        ...
        <div class="aiz-accordion-wrap bg-black">
            ...
            <div class="aiz-accordion-panel bg-transparent" style="background-color: #212121 !important;">
                <div class="container">
        ...
        <div class="row align-items-center py-3">
            ...
            <div class="col-lg-6 order-1 order-lg-0">
                <div class="text-center text-lg-left fs-14" current-verison="{{get_setting("current_version")}}">
                    @php
                        $copyright_text = get_setting('frontend_copyright_text', null, App::getLocale());
                        if (!$copyright_text || str_contains($copyright_text, 'অনুপ্রাণন') || str_contains($copyright_text, 'Creative')) {
                            $copyright_text = '© ' . date('Y') . ' All rights reserved by Cafe De Pasta.';
                        }
                    @endphp
                    {!! $copyright_text !!}
                </div>
            ...
            <div class="col-lg-6 mb-4 mb-lg-0">
                <div class="text-center text-lg-right">
                    <ul class="list-inline mb-0">
                        Developed by <a href="https://www.softsasi.com" target="_blank" title="Softsasi"><span style="color: white;">Softsasi(www.softsasi.com)</span></a>
                    </ul>
                </div>
            </div>
        </div>
