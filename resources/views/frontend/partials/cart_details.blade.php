<div class="container">
    @if ($carts && count($carts) > 0)
        <div class="row mt-5">
            <div class="col-xxl-6 col-xl-6 ">
                <div class="border bg-white p-3 p-lg-4 text-left">
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            @foreach ($carts as $key => $cartItem)
                                @php
                                    ...
                                    $shipping_cost = $shipping_cost + $cartItem['shipping_cost'];
                                ...
                                <li class="list-group-item px-0">
                                    <div class="row gutters-5 align-items-center">
                                            ...
                                            @if ($cartItem['digital'] != 1 && $product->auction_product == 0)
                                                <div
                                                    ...
                                                    <button class="btn col-auto btn-icon btn-sm btn-circle btn-light"
                                                        ...
                                                        data-price="{{ cart_product_price($cartItem, $product, false) }}"
                                                        onclick="updateQuantity({{ $cartItem['id'] }}, 'plus')">
                                                    ...
                                                    <button class="btn col-auto btn-icon btn-sm btn-circle btn-light"
                                                        ...
                                                        data-cart-id="{{ $cartItem['id'] }}"
                                                        data-price="{{ cart_product_price($cartItem, $product, false) }}"
                                                        onclick="updateQuantity({{ $cartItem['id'] }}, 'minus')">
                                        ...
                                        <div class="col-md col-5 order-4 order-md-0 my-3 my-md-0">
                                            ...
                                            <span
                                                class="fw-700 fs-16 text-primary price_change ">{{ single_price(cart_product_price($cartItem, $product, false) * $cartItem['quantity']) }}</span>
                                        </div>
                                        <!-- Remove From Cart -->
                    ...
                    <div class="px-0 py-2 mb-4 border-top d-flex justify-content-between">
                        ...
                        <span class="fw-700 fs-16 sub_total ">৳{{ $total }}</span>
                    </div>
                    <div class="px-0 py-2 mb-4 border-top d-flex justify-content-between">
                        <span class="opacity-60 fs-14">{{ translate('Shipping') }}</span>
                        <span class="fw-700 fs-16 shipping_amount">৳0</span>
                    </div>
                    <div class="px-0 py-2 mb-4 border-top d-flex justify-content-between">
                        <span class="opacity-60 fs-14">{{ translate('Total') }}</span>
                        <span class="fw-700 fs-16 total_amount">৳{{ $total }}</span>
                    </div>
            ...
            <div class="col-xxl-6 col-xl-6">
                @include('frontend.partials.cart_summary1', ['carts' => $carts])
            </div>
