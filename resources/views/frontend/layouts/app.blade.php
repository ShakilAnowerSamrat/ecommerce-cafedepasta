...
<head>
    ...
    <style>
        ...
        @media (max-width: 1199.98px) {
            ...
            .aiz-mobile-bottom-nav .cart-nav-btn {
                position: relative;
                background: linear-gradient(135deg, var(--primary, #e11d48) 0%, #b91c1c 100%);
                color: #fff !important;
                border-radius: 20px;
            ...
            .aiz-mobile-bottom-nav .cart-nav-btn svg path,
            .aiz-mobile-bottom-nav .cart-nav-btn svg rect {
                fill: #fff !important;
            }
            .aiz-mobile-bottom-nav .cart-nav-btn span {
                color: #fff !important;
            }
        }
    </style>
...
@php
    $pixel_id = env('FACEBOOK_PIXEL_ID') ?: '2355381278153504';
@endphp
@if (get_setting('facebook_pixel') == 1 || !empty($pixel_id))
    <!-- Facebook Pixel Code -->
    <script>
