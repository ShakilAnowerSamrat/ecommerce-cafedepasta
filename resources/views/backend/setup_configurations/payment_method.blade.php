            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6 ">{{ translate('PipraPay Credential') }}</h5>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="PIPRAPAY_BASE_URL"
                                        value="{{ env('PIPRAPAY_BASE_URL', 'https://pay.softsasi.com/api') }}"
                                        placeholder="https://pay.softsasi.com/api" required>
                                </div>
                            </div>
                            <div class="form-group row">
