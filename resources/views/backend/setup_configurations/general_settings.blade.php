            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('business_settings.update') }}" method="POST"
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 col-from-label">{{translate('Inside Dhaka')}}</label>
                            <div class="col-sm-9">
                                <input type="hidden" name="types[]" value="inside_dhaka_value">
                                <input type="number" name="inside_dhaka_value" class="form-control" value="{{ get_setting('inside_dhaka_value') }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-3 col-from-label">{{translate('Out side Dhaka')}}</label>
                            <div class="col-sm-9">
                                <input type="hidden" name="types[]" value="outside_dhaka_value">
                                <input type="number" name="outside_dhaka_value" class="form-control" value="{{ get_setting('outside_dhaka_value') }}">
                            </div>
                        </div>
